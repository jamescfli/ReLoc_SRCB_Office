...
for i in np.arange(nb_sample):
    copyfile('datasets/train_test_split_480x1920/test/test_subdir/'+selected_namelist[i],
             'datasets/train_test_split_480x1920/20_image_set/20images/'+selected_namelist[i])
# save label to corresponding .csv file
np.savetxt('datasets/train_test_split_480x1920/20imageset_label_x100.csv', selected_label, delimiter=',')
