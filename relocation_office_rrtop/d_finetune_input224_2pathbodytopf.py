...
from relocation_office_rrtop import build_2path_vgg_bodytopf_model
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    generator_train = datagen_train.flow_from_directory(
        'datasets/train_960x1920_20161125/aug_10_times_body_top_concat/subdir',
    ...
    np.savetxt(
        'training_procedure/convergence_input{}_fc{}body_{}_1125imgx10_ls{}_{}epoch_sgdlr{:.0e}m{}ae{}af{}_l1reg{:.0e}l2reg{:.0e}_reloc_model.csv'
            .format(img_height,
                    nb_hidden_node,
                    initial_weights,
                    label_scalar,
    ...
    model_stacked.save_weights(
        'models/weights_input{}_fc{}body_{}_1125imgx10_ls{}_{}epoch_sgdlr{:.0e}m{}ae{}af{}_l1reg{:.0e}l2reg{:.0e}_reloc_model.h5'
            .format(img_height,
                    nb_hidden_node,
                    initial_weights,
                    label_scalar,
