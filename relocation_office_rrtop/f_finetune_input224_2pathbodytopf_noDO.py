...
if __name__ == '__main__':
    ...
    nb_epoch = 15               # due to higher dimension of 448 img @ network bottle-neck
    nb_epoch_annealing = 5      # anneal for every <> epochs
    ...
    np.savetxt(
        'relocation_office_rrtop/training_procedure/convergence_input{}_fc{}body_div4topf_noDO_{}_1125imgx{}_ls{}_{}epoch_sgdlr{:.0e}m{}ae{}af{}_l1reg{:.0e}l2reg{:.0e}_reloc_model.csv'
            .format(img_height,
                    nb_hidden_node,
                    initial_weights,
                    aug_factor,
    ...
    model_stacked.save_weights(
        'relocation_office_rrtop/models/weights_input{}_fc{}body_div4topf_noDO_{}_1125imgx{}_ls{}_{}epoch_sgdlr{:.0e}m{}ae{}af{}_l1reg{:.0e}l2reg{:.0e}_reloc_model.h5'
            .format(img_height,
                    nb_hidden_node,
                    initial_weights,
                    aug_factor,
