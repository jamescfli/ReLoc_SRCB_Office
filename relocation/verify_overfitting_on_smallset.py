...
np.savetxt('training_procedure/convergence_smallset_vgg2fc{}_places_{}epoch_sgdlr{}m{}_reloc_model.csv'
           .format(nb_fc_nodes, (history_callback.epoch[-1]+1), learning_rate, int(learning_rate_multiplier)),
           record, delimiter=',')
model_stacked.save_weights('models/train_smallset_vgg2fc{}_places_{}epoch_sgdlr{}m{}_reloc_model.h5'
                           .format(nb_fc_nodes,
